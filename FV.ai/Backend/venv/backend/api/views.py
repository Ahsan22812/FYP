...
from .utils import draw_keypoints, draw_connections, get_coordinates, find_angle_and_display
...
class AnnotateVideoView(APIView):
    def post(self, request, format=None):
        ...
        folder_path = 'Train_bicepCurl'
        output_folder_path = 'Train_BicepCurl_ann'
        ...
        for video_file in video_files:
            ...
            while cap.isOpened():
                ...
                # Biceps annotations
                find_angle_and_display(frame, 5, 7, 9, keypoints_with_scores, 0.3, draw=True)
                find_angle_and_display(frame, 6, 8, 10, keypoints_with_scores, 0.3, draw=True)
        ...
        # Serialize and return the annotated video
        # serializer = AnnotatedVideoSerializer(annotated_video)
